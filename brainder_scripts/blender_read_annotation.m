function [vertices, label, colortable] = blender_read_annotation(filename)
...
if(bool)
    ...
    if(numEntries > 0)
        ...
        for i = 1:numEntries
            ...
            colortable.struct_names{i} = colortable.struct_names{i}(1:end);
        ...
        for i = 1:numEntriesToRead
            ...
            colortable.struct_names{structure} = colortable.struct_names{structure}(1:end);
