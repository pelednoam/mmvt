...
def replace_fields(html, patient_name, task_name, nmr_number, scan_date):
...
def main(html_template_fname, scan_fol, patient_name, task_name, mrn, scan_date, output_fname=''):
    ...
    html = replace_fields(html, patient_name, task_name, mrn, scan_date)
