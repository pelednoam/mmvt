import sys
from PyQt5.QtWidgets import QVBoxLayout, QHBoxLayout, QMainWindow, QAction, qApp, QApplication, QWidget, QMessageBox, QDesktopWidget, QCheckBox, QPushButton, QLabel
