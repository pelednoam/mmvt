...
def main(subject, nii_fname):
    # -s subjid --nii "/full_path_to/z.nii.gz" --use_abs_threshold 0 --cb_min_max 2,6 --save_views 1 --hemi rh,lh
    # --views 1,2,6 --add_cb 1 --cb_vals 2,6 --cb_ticks 2,4,6  --rot_lh_axial 1 --join_hemis 1
